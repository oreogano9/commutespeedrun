...
const RARITY_SKINS = {
  default: {
    tiers: [
      ...
      {
        key: "diamond",
        percentileFactor: 0.35,
        minLikes: MIN_DIAMOND_TIER_LIKES,
        minGapFromPrevious: MIN_DIAMOND_TIER_GAP_FROM_PLATINUM,
        minGapFromGold: MIN_DIAMOND_TIER_GAP_FROM_GOLD,
        heatmapWeight: 3.25,
        durationMultiplier: 1.24
      },
      {
        key: "purple",
        percentileFactor: 0.25,
        minLikes: MIN_PURPLE_TIER_LIKES,
        minGapFromPrevious: MIN_PURPLE_TIER_GAP_FROM_DIAMOND,
        heatmapWeight: 3.95,
        durationMultiplier: 1.28
      },
      {
        key: "ruby",
        percentileFactor: 0.12,
        minLikes: MIN_RUBY_TIER_LIKES,
        minGapFromPrevious: MIN_RUBY_TIER_GAP_FROM_PURPLE,
        heatmapWeight: 4.75,
        durationMultiplier: 1.33
      }
    ],
    nonPopularityPrimaryTierKey: "gold",
    nonPopularityEliteTierKey: "diamond"
  },
  borderlands: {
    tiers: [
      ...
      },
      {
        ...
        minGapFromPrevious: 10,
        heatmapWeight: 4.85,
        durationMultiplier: 1.35
      }
    ],
    nonPopularityPrimaryTierKey: "epic",
    nonPopularityEliteTierKey: "legendary-orange"
  }
};
...
function applyOverlayStyles() {
  ...
  overlayElement.dataset.raritySkin = normalizeRaritySkin(raritySkin);
