...
All notable changes to **Kons Youtube Timestamps** (custom fork of CommentSync `1.0.4`).

This timeline is listed in chronological order (oldest -> newest).

## Timeline

1. Forked from CommentSync `1.0.4` and rebranded as **Kons Youtube Timestamps** (name/description updates).
...
- Extension name: `Kons Youtube Timestamps`
